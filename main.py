...
import contacts, mlproject, history, home, map
#non scrivere il .py
...
class MultiApp:
    ...
    def run():
        with st.sidebar:
            app = option_menu(
                menu_title = "Menu",
                options = ["Home", "History", "Map", "Machine Learning Project", "Contacts"],
                icons = ["bi-house", "bi-hourglass-split", "bi-geo-alt", "bi-database", "bi-envelope"],
